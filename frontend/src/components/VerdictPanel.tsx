...
export default function VerdictPanel({ result, loading }: VerdictPanelProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxHeight: '100%', overflow: 'auto' }}>
      {/* Main verdict */}
        ...
        <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ display: 'grid', gap: 12 }}>
            <div className="flex-card" style={{ background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: 10, padding: '12px 16px' }}>
              ...
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 13, color: '#e5e7eb', whiteSpace: 'pre-wrap', wordBreak: 'break-word', maxHeight: 150, overflow: 'auto' }}>
              ...
              <div className="flex-card" style={{ background: 'var(--surface-2)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: 10, padding: '12px 16px' }}>
                ...
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 13, color: '#86efac', whiteSpace: 'pre-wrap', wordBreak: 'break-word', maxHeight: 150, overflow: 'auto' }}>
              ...
              <div className="flex-card" style={{ background: 'var(--surface-2)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: 10, padding: '12px 16px' }}>
                ...
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 13, color: '#fca5a5', whiteSpace: 'pre-wrap', wordBreak: 'break-word', maxHeight: 150, overflow: 'auto' }}>
            ...
            {result.firstFailedCase.stderr && (
              <div className="flex-card" style={{ background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: 10, padding: '12px 16px' }}>
                ...
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 13, color: '#fca5a5', whiteSpace: 'pre-wrap', wordBreak: 'break-word', maxHeight: 200, overflow: 'auto' }}>
                  {result.firstFailedCase.stderr}
                </div>
              </div>
            )}
